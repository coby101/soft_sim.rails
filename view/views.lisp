...
setTimeout(function(){
    ~:*~a.remove();
}, 1000)~%" (javascript:comment-out nil "this file was generated by function destroy.js.erb")
  ...
  (let ((entity (child-entity item))
    ...
    (format nil "~a~%~a~%~a"
            (indent-block nil (data-list-element (ui-label entity :list)
              ...
              (indent-block nil  ;; FIXME interface::make-aspect - not appropriate
                  (list-body (interface::make-aspect entity '(:list) :list-panel (user-attributes entity))
                             actions)))))
